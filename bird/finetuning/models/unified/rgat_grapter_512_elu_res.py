...
from transformers import AutoTokenizer
from .base import PushToHubFriendlyModel
from ..Grapater.modeling_auto_512_elu_res import AutoModelForSeq2SeqLM
...
class Model(PushToHubFriendlyModel):
    def __init__(self, args):
        ...
        from ..Grapater.modeling_t5_512_elu_res import T5ForConditionalGeneration
        ...
        for name, param in self.pretrain_model.named_parameters():
            ...
            #     continue
            if 'ham_tuning' in name or 'relation_emb' in name or 'adapter' in name:
